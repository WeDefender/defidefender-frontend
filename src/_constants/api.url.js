...
export const API_URLS = {
    ...
    COMPNAY_REQUEST_VERIFY_MULTIPARITY_LOAN: BASE_URLS.COMPANY + '/requestVerifyMultiParityLoan',
    COMPANY_LIST_REQUEST_VERIFY_MULTIPARITY_LOAN_RECORDS: BASE_URLS.COMPANY + '/listRequestVerifyMultiParityLoanRecords',
    HANDLE_REQUEST_VERIFY_MULTIPARITY_LOAN_RECORDS:  BASE_URLS.COMPANY + '/handleRequestVerifyMultiParityLoanRecord',
    LIST_MULTI_PARITY_LOAN_INFO: BASE_URLS.COMPANY + '/listMultiParityLoanInfo',
